...
Download the latest pre-release [here](https://github.com/silas-hw/SCNGame/releases/download/v0.4.1/desktop-v0.4.1.jar). Make sure to save it to its own folder, because it will create a 'saves' folder when you run it to store save files.
